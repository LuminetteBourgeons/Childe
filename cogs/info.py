...
class Info(commands.Cog):
  ...
  async def userinfo(self, ctx, user: discord.Member = None):
    ...
    embed = discord.Embed(title=name + "'s Information<:Chchibi:843379361138737182>", color = discord.Color.orange())
  ...
  async def permissions(self, ctx, user: discord.Member = None):
    ...
    embed = discord.Embed(title=f'{user.name}' + "'s Permissions<:Chchibi:843379361138737182>", description=f'`{perms}`', color = discord.Color.orange())
    embed.set_thumbnail(url=avatar)
    embed.set_footer(text=f"Serving: {ctx.author.name}", icon_url=ctx.author.avatar_url)
    await ctx.send(embed=embed)
  ...
  async def serverinfo(self, ctx):
    ...
    embed = discord.Embed(title=name + " Server Information<:Chchibi:843379361138737182>", color = discord.Color.orange())
